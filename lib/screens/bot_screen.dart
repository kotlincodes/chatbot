...
import 'package:yellow_billy_bot/widgets/text_field.dart';
...
class BotScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<BotBloc>(
      bloc: _bloc,
      child: Scaffold(
        appBar: AppBar(title: Text("Billy "),),
        body: BaseWidget(
          ...
          return snapshot.hasData?Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  switch (item.type){
                    case "quickReplies":
                      return QuickReplies(item: item,userResponse: _bloc,);
                    ...
                    case "text":
                      ...
                      return
                          BotResponse(
                            message: item.elements.toString().replaceAll("[", "").replaceAll("]", ""),
                          );


                    case "card":
                      return CardWidget(response: item,userResponse: _bloc);

                    case "user":
                      return UserResponse(response: item.userResponse,);
