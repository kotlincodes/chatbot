...
interactionsUserSayFromJson(InteractionsUserSay data, Map<String, dynamic> json) {
...
interactionsResponseFromJson(InteractionsResponse data, Map<String, dynamic> json) {
	if (json['type'] != null) {
	...
	if (json['userResponse'] != null) {
		data.userResponse = new InteractionsResponsesButton().fromJson(json['userResponse']);
	}
...
interactionsResponsesButtonFromJson(InteractionsResponsesButton data, Map<String, dynamic> json) {
...
Map<String, dynamic> interactionsResponsesButtonToJson(InteractionsResponsesButton entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
